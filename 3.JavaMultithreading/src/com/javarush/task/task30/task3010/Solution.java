    ...
    public static void main(String[] args) {
        try {
            ...
            if (string.matches("[A-Z0-9]+")) {
                Arrays.sort(chars);
                if (chars[chars.length - 1] >= "A".charAt(0))
                    System.out.println(((int) chars[chars.length - 1] - 65) + 11);
                else {
                    if (((int) chars[chars.length - 1] - 48 <= 1)) System.out.println(2);
                    else System.out.println((int) chars[chars.length - 1] - 47);
                }
