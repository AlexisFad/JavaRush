...
public class Solution implements Serializable {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("/Users/Alex/Алексей/JavaRush/test/test.txt"));
        ObjectInputStream ios = new ObjectInputStream(new FileInputStream("/Users/Alex/Алексей/JavaRush/test/test.txt"));

        Solution saveObject = new Solution(4);
        oos.writeObject(saveObject);
        oos.close();

        Solution saveObject2 = new Solution(2);
